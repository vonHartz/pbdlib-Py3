...
This is a copy of [pbdlib-python](https://gitlab.idiap.ch/rli/pbdlib-matlab/), naively translated into Python 3 code using the `2to3` util.
All credit belongs to the original authors.
All errors due to translation are mine. Feel free to open pull requests to help fix remaining errors, eg. in the notebooks.
